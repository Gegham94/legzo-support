export const defaultThemeStyles = {
  light: {
    ...
    message: {
      ...
      privateMessageInactive: "#A2A2A2",
      privateMessageActive: "#626262"
    },
...
export const cssThemeVars = ({
  ...
  return {
    ...
    "--chat-message-private-color-inactive-label":
      message.privateMessageInactive,
    "--chat-message-private-color-active-label": message.privateMessageActive,
    ...
    "--chat-icon-color-hashtag": icons.hashtag,
