...
function Takehiro() {
  ...
  function choose_table(ix, ixPos, endPos, s) {
    let max = ix_max(ix, ixPos, endPos);
  ...
  function recalc_divide_init(
    ...
    for (var r0 = 0; r0 < 16; r0++) {
      ...
      const r0t = choose_table(ix, 0, a1, bi);
      r0bits = bi.bits;
      ...
      for (let r1 = 0; r1 < 8; r1++) {
        ...
        let bits = r0bits;
        bi = new Bits(bits);
        const r1t = choose_table(ix, a1, a2, bi);
        bits = bi.bits;
  ...
  function recalc_divide_sub(
    ...
    for (let r2 = 2; r2 < Encoder.SBMAX_l + 1; r2++) {
      ...
      const r2t = choose_table(ix, a2, bigv, bi);
      bits = bi.bits;
