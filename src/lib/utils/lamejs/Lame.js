...
const new_short_n = common.default.new_short_n;
...
function Lame() {
  ...
  function optimum_bandwidth(lh, bitrate) {
    ...
    const table_index = self.nearestBitrateFullIndex(bitrate);
  ...
  this.lame_init_params = function (gfp) {
    ...
    } else gfc.sideinfo_len = gfc.channels_out == 1 ? 4 + 9 : 4 + 17;
    /* MPEG 2 */
  ...
  this.lame_encode_flush = function (
    ...
    const gfc = gfp.internal_flags;
    const buffer = new_short_n([2, 1152]);
    let imp3 = 0;
    let mp3count;
    ...
    const mf_needed = calcNeeded(gfp);
  ...
  function lame_encode_frame(
    ...
    const ret = self.enc.lame_encode_mp3_frame(
      gfp,
      inbuf_l,
      inbuf_r,
      mp3buf,
