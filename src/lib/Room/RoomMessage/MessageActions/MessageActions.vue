  ...
  <div class="vac-message-actions-wrapper">
    ...
    >
      <transition-group name="vac-slide-left" tag="span">
        <div
          ...
          :class="{
            'vac-options-me': message.from_user_id === currentUserId
          }"
        />
        ...
        <div v-if="isMessageReactions" key="3" v-click-outside="closeEmoji">
          ...
          >
            <emoji-picker-container
              ...
              :emoji-reaction="true"
              :position-right="message.from_user_id === currentUserId"
    ...
    >
      <div
        ...
        :class="{
          'vac-menu-left': message.from_user_id !== currentUserId
        }"
...
export default {
  ...
  computed: {
    ...
    filteredMessageActions() {
      return this.message.from_user_id === this.currentUserId
        ? this.messageActions
