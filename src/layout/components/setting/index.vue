...
<template>
  <panel>
    ...
    <el-divider>navbar mode</el-divider>
    <ul class="pure-theme">
      <el-tooltip
    ...
    <el-divider>interface display</el-divider>
    <ul class="setting">
      <li>
      ...
      <li>
        <span class="dark:text-white">hide tab</span>
        <el-switch
      ...
      <li>
        <span class="dark:text-white">Sidebar Logo</span>
        <el-switch
          v-model="logoVal"
          inline-prompt
          :active-value="true"
      ...
      <li>
        <span class="dark:text-white">label style</span>
        <el-radio-group v-model="markValue" size="small" @change="onChange">
          <el-radio label="card">card</el-radio>
          <el-radio label="smart">agile</el-radio>
        </el-radio-group>
      </li>
    </ul>
