...
import { useReturningCustomerHooks } from "./hooks";
...
const { isInputsEmpty, radioValue, filter } = useReturningCustomerHooks();
...
<template>
  <div class="filter">
    ...
    >
      ...
      >
        <svg-icon
          :name="hoveringOnFilter ? 'cross' : 'returning'"
    ...
    <div class="content-wrapper" v-show="filter.isOpen">
      <div class="content-wrapper_header">
        <div class="title">
          <svg-icon name="returning" class="title-icon" />
      ...
      <div class="content-wrapper_body">
        <el-radio-group v-model="radioValue" class="radio-group">
          <el-radio label="is_true" size="large">is true</el-radio>
          <el-radio label="is_false" size="large">is false</el-radio>
        </el-radio-group>
      </div>
