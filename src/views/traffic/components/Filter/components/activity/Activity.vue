...
import { useActivityHooks } from "./hooks";
...
<template>
  <div class="filter">
    <el-tooltip content="Activity" placement="top" popper-class="pure-tooltip">
      <div
        class="filter_state"
      ...
      >
        <svg-icon
          :name="hoveringOnFilter ? 'cross' : 'chart'"
    ...
    <div class="content-wrapper" v-show="filter.isOpen">
      <div class="content-wrapper_header">
        <div class="title">
          <svg-icon name="chart" class="title-icon" />
