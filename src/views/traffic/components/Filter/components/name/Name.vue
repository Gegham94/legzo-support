...
import { useNameHooks } from "./hooks";
...
<template>
  <div class="filter">
    <el-tooltip content="Name" placement="top" popper-class="pure-tooltip">
      <div
        class="filter_state"
      ...
      >
        <svg-icon
          :name="hoveringOnFilter ? 'cross' : 'agent'"
    ...
    <div class="content-wrapper" v-show="filter.isOpen">
      <div class="content-wrapper_header">
        <div class="title">
          <svg-icon name="agent" class="title-icon" />
