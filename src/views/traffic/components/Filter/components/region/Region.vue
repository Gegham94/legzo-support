...
import { useRegionHooks } from "./hooks";
...
<template>
  <div class="filter">
    <el-tooltip content="Region" placement="top" popper-class="pure-tooltip">
      <div
        class="filter_region"
      ...
      >
        <svg-icon
          :name="hoveringOnFilter ? 'cross' : 'location'"
          class="filter_region-icon"
          @click="removeFilter"
        />
        <div class="filter_region-text">
          <strong class="filter_region-text-label"
    ...
    <div class="content-wrapper" v-show="filter.isOpen">
      <div class="content-wrapper_header">
        <div class="title">
          <svg-icon name="location" class="title-icon" />
