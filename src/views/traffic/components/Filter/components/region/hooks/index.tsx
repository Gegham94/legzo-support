...
export function useRegionHooks() {
  ...
  const isInputsEmpty = computed(() => {
    switch (radioValue.value) {
      case "is_exactly":
        ...
        params.value = {
          regionIsExactly: [selectIsExactlyValue.value],
          key: "is exactly"
        };
        break;
      case "is_not":
        ...
        selectHasAnyValue.value = "";
        params.value = {
          regionIsNot: [selectIsNotValue.value],
          key: "is not"
        };
        break;
      case "contains":
        ...
        selectHasAnyValue.value = "";
        params.value = {
          regionContains: [selectContainsValue.value],
          key: "contains"
        };
        break;
      case "does_not_contains":
        ...
        selectHasAnyValue.value = "";
        params.value = {
          regionDoesNotContains: [selectDoseNotContainsValue.value],
      ...
      case "has_any_value":
        ...
        params.value = {
          regionHasAnyValue: [selectHasAnyValue.value],
          key: "has any value"
        };
        break;
    }
