  ...
  const isInputsEmpty = computed(() => {
    switch (radioValue.value) {
      case "is_exactly":
        ...
        params.value = {
          emailIsExactly: [selectIsExactlyValue.value],
          key: "is exactly"
        };
        break;
      case "is_not":
        ...
        selectHasAnyValue.value = "";
        params.value = {
          emailIsNot: [selectIsNotValue.value],
          key: "is not"
        };
        break;
      case "contains":
        ...
        selectHasAnyValue.value = "";
        params.value = {
          emailContains: [selectContainsValue.value],
          key: "contains"
        };
        break;
      case "does_not_contains":
        ...
        selectHasAnyValue.value = "";
        params.value = {
          emailDoesNotContains: [selectDoseNotContainsValue.value],
      ...
      case "has_any_value":
        ...
        params.value = {
          emailHasAnyValue: [selectHasAnyValue.value],
          key: "has any value"
        };
        break;
    }
